	...
	<c:if test="${RESULT == 'SUCCESS' }">
		<div class="container">
			<div class="goods">
				<div class="row">
					<div class="col-lg-5">
						<img src="/onlinetemp/upload/image/${goods.photourl}" width="425" height="425"/>
					</div>
					<div class="col-lg-6 goodstitle">
						...
						<p><span class="bold">商品简介：&nbsp;</span>${goods.name }&nbsp;${goods.title}</p>
				...
				<div class="goodsmessage">
					...
					<h3>商品介绍</h3>
					<div class="row">
						<div class="col-lg-12"><img src="/onlinetemp/upload/image/${goods.messageurl }" width="1000px"/></div>
					</div>
				</div>
			</div>
		</div>
