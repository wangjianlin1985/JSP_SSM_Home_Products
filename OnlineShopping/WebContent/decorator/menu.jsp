...
<body>
	<div id="contleft">
		<ul class="menu">
			...
			<li class="level1">
			<a href="javascript:void(0)">安装管理</a>
				<ul class="level2">
	                <li><a href="<%=basePath%>back/roleinstalllist?currentPage=1">安装列表</a></li>
                </ul>
			</li>
			<li class="level1">
			...
			<li class="level1">
			<a href="javascript:void(0)">推广管理</a>
				<ul class="level2">
	                <li><a href="<%=basePath%>back/addactive">添加推广</a></li>
	                <li><a href="<%=basePath%>back/roleactivelist?currentPage=1">推广列表</a></li>
                </ul>
			</li>
		</ul>
